...
public class Upgradeactivity extends Activity{
	...
	public void getitem(){
		...
		TextView upgradecount=(TextView)findViewById(R.id.upgradecount);
		upgradecount.setText("共有"+layout.getChildCount()+"可更新");
