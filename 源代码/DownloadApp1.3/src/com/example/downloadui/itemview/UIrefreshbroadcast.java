...
public class UIrefreshbroadcast extends BroadcastReceiver{
	...
	public void onReceive(Context arg0, Intent intent) {
		// TODO Auto-generated method stub
				...
				((TextView) downloaditem.findViewById(R.id.softwareinformation)).setText(db.Query("content",id));
				...
				new Getpicture().getpicture(db.Query("directory_img",id),((ImageView)downloaditem.findViewById(R.id.softwarepicture)));
	...
	downloadinfo.setOnClickListener(new Softwareitemonclicklistener(intent.getStringExtra("id"),intent.getAction()));
	}
