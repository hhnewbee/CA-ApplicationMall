...
public class Infoactivity extends Activity implements OnClickListener{
	...
	public void settextandimageandbutton(){
		...
		text1.setText(db.Query("true_name",type,id)+" : "+Math.round(Float.parseFloat(db.Query("size",type,id).substring(0,db.Query("size",type,id).indexOf("k")))/1024)+"MB");
		TextView text2=(TextView)findViewById(R.id.info2);
		text2.setText(db.Query("content",type,id));
		TextView text3=(TextView)findViewById(R.id.info_softwarename);
		text3.setText(db.Query("true_name",type,id));
